...
```
Inside robot, esp32-n4r16 is connected to the robot wheel motors, upon receiving a command from the server, it moves the robot accordingly by calculating the distance, motor speed and direction to move.

## Robot hardware workflow
